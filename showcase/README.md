...
A visual index of **every facet in Prism** — 3356 effects across 17 galleries, each recorded as a looping GIF from its own standalone HTML sample.
...
Stats: 3099 animated · 257 static (single-frame GIF) · 81.4 MB total · 10 fps, 1.6–4 s per clip · rendered by Firefox (WebDriver BiDi) 155.0.1 · generated 2026-09-06.
