...
A visual index of **every facet in Prism** — 2668 effects across 15 galleries, each recorded as a looping GIF from its own standalone HTML sample.
...
Stats: 2411 animated · 257 static (single-frame GIF) · 57.1 MB total · 10 fps, 1.6–4 s per clip · rendered by Firefox (WebDriver BiDi) 155.0 · generated 2026-09-04.
