...
A visual index of **every facet in Prism** — 3422 effects across 17 galleries, each recorded as a looping GIF from its own standalone HTML sample.
...
Stats: 3165 animated · 257 static (single-frame GIF) · 85.0 MB total · 10 fps, 1.6–4 s per clip · rendered by Chromium (CDP) Edg/152.0.4191.66 · generated 2026-09-06.
