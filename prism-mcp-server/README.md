...
└── test/             # node:test integration + unit tests (62 tests)
```
...
62 tests cover every tool, the CSS/compose/validate utilities, the JSON-RPC protocol layer, and loading the real `Prism.html` island.
